...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vizit.registration_date'
        db.add_column('core_vizit', 'registration_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 10, 8, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vizit.registration_date'
        db.delete_column('core_vizit', 'registration_date')

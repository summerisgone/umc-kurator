...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Certificate.number'
        db.delete_column('core_certificate', 'number')

        # Adding field 'Certificate.cert_number'
        db.add_column('core_certificate', 'cert_number',
                      self.gf('django.db.models.fields.IntegerField')(default=0,
                          unique=True), keep_default=False)


    def backwards(self, orm):
        # Adding field 'Certificate.number'
        db.add_column('core_certificate', 'number',
                      self.gf('django.db.models.fields.CharField')(unique=True, max_length=64, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Certificate.cert_number'
        db.delete_column('core_certificate', 'cert_number')
    ...
    models = {
        ...
        'core.certificate': {
            ...
            'cert_number': ('django.db.models.fields.IntegerField', [], {'unique': 'True'}),

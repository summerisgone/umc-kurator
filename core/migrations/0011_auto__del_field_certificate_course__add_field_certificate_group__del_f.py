...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Certificate.course'
        db.delete_column('core_certificate', 'course_id')

        # Adding field 'Certificate.group'
        db.add_column('core_certificate', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['core.StudyGroup']),
                      keep_default=False)

        # Deleting field 'Vizit.course'
        db.delete_column('core_vizit', 'course_id')

        # Adding field 'Vizit.group'
        db.add_column('core_vizit', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['core.StudyGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Certificate.course'
        db.add_column('core_certificate', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['core.StudyGroup']),
                      keep_default=False)

        # Deleting field 'Certificate.group'
        db.delete_column('core_certificate', 'group_id')

        # Adding field 'Vizit.course'
        db.add_column('core_vizit', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['core.StudyGroup']),
                      keep_default=False)

        # Deleting field 'Vizit.group'
        db.delete_column('core_vizit', 'group_id')

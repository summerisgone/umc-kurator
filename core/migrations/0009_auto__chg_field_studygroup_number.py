...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StudyGroup.number'
        db.alter_column('core_studygroup', 'number', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'StudyGroup.number'
        db.alter_column('core_studygroup', 'number', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

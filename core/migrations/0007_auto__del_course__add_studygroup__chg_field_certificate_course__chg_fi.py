...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_studygroup', (
        ...
        db.send_create_signal('core', ['StudyGroup'])


        # Changing field 'Certificate.course'
        db.alter_column('core_certificate', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.StudyGroup']))

        # Changing field 'Subject.hours'
        db.alter_column('core_subject', 'hours', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=64))

        # Changing field 'Vizit.course'
        db.alter_column('core_vizit', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.StudyGroup']))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('core_studygroup')


        # Changing field 'Certificate.course'
        db.alter_column('core_certificate', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Course']))

        # Changing field 'Subject.hours'
        db.alter_column('core_subject', 'hours', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Vizit.course'
        db.alter_column('core_vizit', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Course']))

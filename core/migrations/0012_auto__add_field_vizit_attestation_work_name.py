...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vizit.attestation_work_name'
        db.add_column('core_vizit', 'attestation_work_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vizit.attestation_work_name'
        db.delete_column('core_vizit', 'attestation_work_name')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Certificate.name'
        db.delete_column('core_certificate', 'name')

        # Deleting field 'Certificate.cast'
        db.delete_column('core_certificate', 'cast')

        # Adding unique constraint on 'Certificate', fields ['number']
        db.create_unique('core_certificate', ['number'])


    def backwards(self, orm):
        # Removing unique constraint on 'Certificate', fields ['number']
        db.delete_unique('core_certificate', ['number'])

        # Adding field 'Certificate.name'
        db.add_column('core_certificate', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Certificate.cast'
        db.add_column('core_certificate', 'cast',
    ...
    models = {
        ...
        'core.certificate': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.StudyGroup']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'listener': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.Listener']"}),
            'number': ('django.db.models.fields.CharField', [], {'max_length': '64', 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        'core.department': {
        ...
        'core.studygroup': {
            ...
            'department': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'groups'", 'to': "orm['core.Department']"}),
            ...
            'students': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'group'", 'symmetrical': 'False', 'through': "orm['core.Vizit']", 'to': "orm['auth.Listener']"}),
        ...
        'core.vizit': {
            ...
            'attestation_work_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
